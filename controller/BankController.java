...
*/			case "17": 
				...
				case "3": 
					...
					break;
				case "4": 
					JOptionPane.showMessageDialog(null, articleService.findOne(
							Integer.parseInt(JOptionPane.showInputDialog("검색 할 글번호"))));
					break;
				case "5": 
					JOptionPane.showMessageDialog(null, articleService.countTitle());
					break;
				case "6": //글 존재 유무
					
					String ok=(articleService.existTitle(JOptionPane.showInputDialog("글번호"),
							JOptionPane.showInputDialog("글제목")))? "글 존재O" : "글 존재X";
					JOptionPane.showMessageDialog(null, ok);
					
					break;
				case "7": //글 수정
					String seq = JOptionPane.showInputDialog("글번호");
					bulletinPass = JOptionPane.showInputDialog("글비번");
					String newContent = JOptionPane.showInputDialog("수정내용");
					articleService.updateBulletin(seq, bulletinPass, newContent);
					break;
				case "8": //글 삭제
					articleService.deleteBulletin(JOptionPane.showInputDialog("글제목"),
							JOptionPane.showInputDialog("게시글 비번"));
					break;
				case "9": break;
				case "10": break;
				case "11": break;
